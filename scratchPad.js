...
function onOpen() {
    DocumentApp.getUi()
        ...
        .addSeparator()
        .addItem('Generate Preview Doc', 'generatePreviewDoc')
        .addSeparator()
        .addItem('About Mail Merge', 'showAbout')
        .addToUi();
  }
  
  /**
   * Shows the about dialog with information about the add-on.
   */
  function showAbout() {
    const ui = DocumentApp.getUi();
    ui.alert('About Mail Merge',
        'Mail Merge enables you to send personalized emails using your Google Doc as a template and data from a spreadsheet.\n\n' +
        'Use placeholders like {{columnName}} in your document to substitute with data from your spreadsheet.\n\n' +
        'Version 2.0',
        ui.ButtonSet.OK);
  }
  ...
  function showSidebar() {
    const ui = HtmlService.createTemplateFromFile('ImprovedSidebar')
        .evaluate()
        .setTitle('Mail Merge')
   ...
   */
  function sendTestEmail(recipients, subject, fromEmail, fromName, cc, bcc) {
    try {
